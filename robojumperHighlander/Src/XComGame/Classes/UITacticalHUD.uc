...
simulated function InitScreen(XComPlayerController InitController, UIMovie InitMovie, optional name InitName)
{
	...
	// Shot Stats wings
	m_kShotInfoWings = Spawn(class'UITacticalHUD_ShotWings', self).InitShotWings();

	// Target Reticle
	m_kTargetReticle = Spawn(class'UITargetingReticle', self).InitTargetingReticle();
...
simulated function OnInit()
{
	...
	else
	{
		...
		m_kCommanderHUD = Spawn(class'UITacticalHUD_CommanderHUD', self).InitCommanderHUD();
