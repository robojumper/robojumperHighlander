...
// robojumperHighlander: Fix mind cintrol removal via abilities not properly updating AI data
simulated function UpdateAIData(XComGameState NewGameState, XComGameState_Unit MindControlledUnit, optional bool bAdded = false)
{
