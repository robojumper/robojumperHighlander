...
enum ERetainConcealmentResult
{
	eRetainConcealment_DoesNotModify,
	eRetainConcealment_DoesBreakConcealment,
	eRetainConcealment_DoesRetainConcealment,
};
...
// robojumperHighlander: Allow effects to maybe retain / break concealment depending on various circumstances
function ERetainConcealmentResult ModifyRetainConcealmentRule(XComGameStateContext_Ability Context, XComGameState_Effect EffectState) { return eRetainConcealment_DoesNotModify; }
