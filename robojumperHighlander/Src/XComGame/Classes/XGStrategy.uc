...
state StartingFromTactical
{
	...
	// robojumperHighlander
	function AddDropshipInteriorStreamingMaps(vector vLoc, rotator rRot)
	{
		local string strAddDropShipMatinee;

		foreach class'robojumperHighlander'.default.AdditionalDropshipInteriorMatinees(strAddDropShipMatinee)
		{
			`MAPS.AddStreamingMap(strAddDropShipMatinee, vLoc, rRot, false);
		}
	}

	function RemoveDropshipInteriorStreamingMaps()
	{
		local string strAddDropShipMatinee;
		foreach class'robojumperHighlander'.default.AdditionalDropshipInteriorMatinees(strAddDropShipMatinee)
		{
			`MAPS.RemoveStreamingMapByName(strAddDropShipMatinee, false);
		}
	}
...
Begin:
	...
	if(ShowDropshipInterior()) 
	{
		...
		// robojumperHighlander
		AddDropshipInteriorStreamingMaps(DropshipLocation, DropshipRotation);
	...
	if(ShowDropshipInterior())
	{
		...
		// robojumperHighlander
		RemoveDropshipInteriorStreamingMaps();
