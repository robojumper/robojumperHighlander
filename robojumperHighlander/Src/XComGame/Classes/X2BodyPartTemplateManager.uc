...
protected event InitTemplatesInternal()
{
	...
	// robojumperHighlander: Allow dynamically updating BodyPartTemplates prior to creation
	...
	{
		DLCInfo.OnPreBodyPartTemplatesCreated(BodyPartTemplateConfig, ValidPartTypes);
	}
