...
function UpdateFlyoverText()
{
	...
	// robojumperHighlander: Add doom to mission items, deprecating AlienNetworkComponent
...
simulated function Show()
{
	...
	// robojumperHighlander: Pips fix
	if( bIsFocused || !bShouldOnlyShowOnFocus)
		super.Show();
}
